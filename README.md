...
git add . # Staging all the currents changes of the code
git add *.py # Adding an specific extension files
git commit -m 'Your commit message here!' # How to write commits and the respecting context 
